...
public class Gestion_Emprunt_Affichage_all extends JPanel {
	static JFrame f;
	public Gestion_Emprunt_Affichage_all()
	{ 
		JPanel Jforme = new JPanel(); 
		Jforme.setLayout(new GridLayout(20, 3));
		JLabel messAcc = new JLabel("Voici le lien permettant de retrouver l'ensemble des emprunts:");
		...
		Jforme.add(new Label(""), BorderLayout.CENTER);
		Jforme.add(new Label(""), BorderLayout.CENTER);
		JTextField lien = new JTextField("                             http://localhost:8002/getEmprunt/All");
		...
		retour.addActionListener(new ListenerFrame3());
	}
	
}

class ListenerFrame3 extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand()== "Revenir au menu de gestion des emprunts"){
			...
			Gestion_Emprunt_Affichage_all.f.dispose();
		}
	}
